...
content_image_path = r"c:\Users\24514\Desktop\091f9c0dee09c12228629c08ca53b4e5.jpg"  # 使用原始字符串
style_image_path = r"c:\Users\24514\Desktop\e2ca7b821d617b79609f9ed4d7d4342.jpg"  # 使用原始字符串
# 或者使用正斜杠（推荐）
...
def load_model_with_retry():#定义了一个名为 load_model_with_retry 的函数，用于尝试多种方式加载模型，并在失败时进行重试
    ...
    local_model_path = "./model/magenta_arbitrary-image-stylization-v1-256_2"
